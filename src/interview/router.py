...
from .schema import PeopleAdd, ResponeAfterCreate, TaskSchema,ResponseTests
...
@app.post("/tasks/test")
async def run_python_code(data:ResponseTests, session:AsyncSession = Depends(get_session)):
